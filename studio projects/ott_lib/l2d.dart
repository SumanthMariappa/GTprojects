...
class Pageld extends StatefulWidget {
  @override
  State<Pageld> createState() => _PageldState();
}

class _PageldState extends State<Pageld> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5yXIEM6gWqHdPglvsuGYjNCUu_gPXSE8rfA&s"),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("Kanguva is an epic saga where ancient valour meets modern-day courage, revolving around an ancient warrior's struggle to save his people a millennium ago and the mysterious link to a shadow cop's, quest in the present.",
            ...
            Padding(
              ...
              child: Text("IMDb 8.0/10",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
