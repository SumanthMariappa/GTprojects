...
class Pagel3 extends StatefulWidget {
  @override
  State<Pagel3> createState() => _Pagel3State();
}

class _Pagel3State extends State<Pagel3> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://rukminim2.flixcart.com/image/750/900/jyj0how0/poster/m/n/p/medium-deadpool-wall-poster-19-inch-x-13-inch-ra137poster-original-imafgqthqyrr4xj7.jpeg?q=20&crop=false"),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("Deadpool is the alter ego of Wade Wilson, a disfigured Canadian mercenary with superhuman regenerative healing abilities. He is known for his tendency to joke incessantly and break the fourth wall for humorous effect. (June 2018). Art by Rob Liefeld.",
            ...
            Padding(
              ...
              child: Text("IMDb 9.0/10",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),

            Padding(
              padding: const EdgeInsets.only(right: 260,bottom: 20),
              child: Text("Seasons: 3",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
