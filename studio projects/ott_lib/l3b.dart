...
class l3b extends StatefulWidget {
  @override
  State<l3b> createState() => _l3bState();
}

class _l3bState extends State<l3b> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://static.theprint.in/wp-content/uploads/2022/11/ANI-20221129125434.jpg"),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("Synopsis. Pushpa Raj is a self respecting young man who takes pride in his work. He works at a mill, but leaves it when his owner doesn't like his attitude outside of work. Pushpa goes for Red sanders cutting in the forest.",
