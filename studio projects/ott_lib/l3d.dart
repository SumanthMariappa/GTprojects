...
class l3d extends StatefulWidget {
  @override
  State<l3d> createState() => _l3dState();
}

class _l3dState extends State<l3d> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://upload.wikimedia.org/wikipedia/en/3/39/Jawan_film_poster.jpg"),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("The film stars Shah Rukh Khan, alongside Nayanthara (in her Hindi film debut), Vijay Sethupathi, Deepika Padukone, Priyamani and Sanya Malhotra. In the film, a jailer of a woman's prison recruits inmates and commit outrageous crimes that shed light on corruption.",
