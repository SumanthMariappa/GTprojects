...
class Pagelb extends StatefulWidget {
  @override
  State<Pagelb> createState() => _PagelbState();
}

class _PagelbState extends State<Pagelb> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTb2wYrStUERFLHGzJ9-FeLvLyu16SsT_XbJg&s"),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("A series of unfortunate events lead Raayan, a simpleton to be dragged into the dreaded world of crime and manipulation. A series of unfortunate events lead Raayan, a simpleton to be dragged into the dreaded world of crime and manipulation.",
            ...
            Padding(
              ...
              child: Text("IMDb 6.0/10",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
