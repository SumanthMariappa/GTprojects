...
class l3a extends StatefulWidget {
  @override
  State<l3a> createState() => _l3aState();
}

class _l3aState extends State<l3a> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://mir-s3-cdn-cf.behance.net/project_modules/1400/869d6274284099.5c2a29444e565.png"),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("The film centres around Raja Krishnappa Bairya ('Rocky'), born into poverty, who arrives in Bombay (now Mumbai) in the 1960s, on a quest for power and wealth as desired by his dying mother. Involved with the gold mafia there, he is recruited to kill Garuda, the oppressive heir-in-waiting, at the Kolar Gold Fields.",
            ...
            Padding(
              ...
              child: Text("MOVIES",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
