        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage("assets/master1.jpg"),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("Master is an action film from India about a professor, JD, who is sent to teach at a juvenile reform school for three months. He clashes with an unscrupulous man, Bhavani, who controls the school's young inmates to cover up his own criminal activities.",
            ...
            Padding(
              ...
              child: Text("IMDb 7.5/10",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),

            Padding(
              padding: const EdgeInsets.only(right: 260,bottom: 20),
              child: Text("Movies: 1",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
