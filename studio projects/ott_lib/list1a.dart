...
class Pagel1 extends StatefulWidget {
  @override
  State<Pagel1> createState() => _Pagel1State();
}

class _Pagel1State extends State<Pagel1> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://m.media-amazon.com/images/S/pv-target-images/729e3965d4dfb822eadcd64356df8656adfb31d66e7c1b3520cb974289c26976.jpg",),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("Summaries. Chris and a group of five friends are left stranded deep in the middle of the woods after their cars collide. As they venture deeper into the woods, they face an uncertain and bloodcurdling fate.",
            ...
            Padding(
              ...
              child: Text("IMDb 8.7/10",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
