...
class Pagel2 extends StatefulWidget {
  @override
  State<Pagel2> createState() => _Pagel2State();
}

class _Pagel2State extends State<Pagel2> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQX2loHap3U2PtBKc_2F7zd_Td7NPYmKb-8Mg&s"),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("The film sees Batman, in his second year fighting crime in Gotham City, uncover corruption with ties to his own family while pursuing the Riddler (Dano), a mysterious serial killer targeting the city's elite. Development began after Ben Affleck was cast as Batman in the DC Extended Universe (DCEU) in 2013.",
            ...
            Padding(
              ...
              child: Text("IMDb 7.7/10",style: TextStyle(color: Colors.grey,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
