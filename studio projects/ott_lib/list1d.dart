...
class Pagel4 extends StatefulWidget {
  @override
  State<Pagel4> createState() => _Pagel4State();
}

class _Pagel4State extends State<Pagel4> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage("https://m.media-amazon.com/images/I/91JcxXUJc8L._UF1000,1000_QL80_.jpg",),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
            ...
            Padding(
              ...
              child: Text("Premise and plot. Game of Thrones follows a large cast of characters and interwoven story arcs. It is primarily set on the fictional continent of Westeros, which is divided into the Seven Kingdoms and the lands in the far North beyond “the Wall,” an enormous wall of fortified ice",
